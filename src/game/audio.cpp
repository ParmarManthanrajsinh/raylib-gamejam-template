...
namespace
{
    ...
    Sound GenerateSfx(float duration, float freq_start, float freq_end, float amp, int wave_type)
    {
...
{
    InitAudioDevice();
    sounds[static_cast<int>(SfxType::PLACE_GATE)]     = GenerateSfx(0.06f, 600, 200, 1.0f, 0);
    sounds[static_cast<int>(SfxType::REMOVE_GATE)]    = GenerateSfx(0.05f, 100, 100, 0.4f, 2);
    sounds[static_cast<int>(SfxType::CONNECT_WIRE)]   = GenerateSfx(0.05f, 800, 800, 0.8f, 1);
    sounds[static_cast<int>(SfxType::DISCONNECT_WIRE)] = GenerateSfx(0.04f, 600, 200, 0.6f, 0);
    sounds[static_cast<int>(SfxType::TOGGLE_INPUT)]   = GenerateSfx(0.03f, 1000, 1000, 0.7f, 0);
    sounds[static_cast<int>(SfxType::SOLVED)]         = GenerateArpeggio();
    sounds[static_cast<int>(SfxType::ERROR)]          = GenerateSfx(0.08f, 150, 150, 0.5f, 1);
}
