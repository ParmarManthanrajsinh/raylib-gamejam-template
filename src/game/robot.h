...
public:
    ...
    void Update(float game_anim_time, Vector2 mouse_pos, float level_timer, 
...
private:
    ...
    void Speak(const std::string& text, int priority = 1, RobotMood mood = RobotMood::IDLE, float duration = 4.0f);
